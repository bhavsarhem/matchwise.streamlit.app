...
st.title("""
Matchmaker for Careers: Unveiling Your Resume's Job Potential
""")
...
# Upload Resume
uploaded_file = st.file_uploader("Upload Your Resume", type=["pdf", "docx"], help="Please upload a PDF/DOCX file")
...
if submit_button:
    if uploaded_file is not None:
        ...
        if match_percentage >= 75:
            ...
            st.text("Not a Match ☹️🥺, Best wishes for your job search!🍀🌈🌟")
